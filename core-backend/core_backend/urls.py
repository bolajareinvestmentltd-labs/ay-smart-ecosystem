...
from core_api.views import (
    ...
    AdminOperationsDashboardView, AdminFinancialAuditView, EscrowCreateView, EscrowReviewView,
...
urlpatterns = [
    ...
    path("api/support/assistant/", __import__('core_api.views', fromlist=['']).SupportAssistantView.as_view(), name="support_assistant"),
    ...
    path("api/escrows/create/", EscrowCreateView.as_view(), name="escrow_create"),
    path("api/escrows/review/", EscrowReviewView.as_view(), name="escrow_review"),
    path("api/admin/financial-audit/", AdminFinancialAuditView.as_view(), name="admin_financial_audit"),
    ...
    path("api/payments/paystack/webhook/", __import__('core_api.views', fromlist=['']).PaystackPaymentWebhookView.as_view(), name="paystack_payment_webhook"),
